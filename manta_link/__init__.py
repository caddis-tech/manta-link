...
sends off the reader's thread, tagging each one with where the boat was, and
making them durable: a spool for the upload to drain, and an archive that keeps
